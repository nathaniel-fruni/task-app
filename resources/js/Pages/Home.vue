<template>
    ...
    <div
        ...
        <div
            ...
            <p
                class="text-[#E6E7E8] lg:text-2xl/10 lg:w-md">
                Jednoduchý spôsob, ako mať svoje úlohy pod kontrolou.
            </p>
            <Link
                href="/tasks"
                type="button"
                class="hover:shadow-[0_6px_20px_rgba(255,255,255,23%)] hover:bg-[rgba(255,255,255,0.9)]
